class Relationship < ApplicationRecord
  ...
  validates :relation_to, inclusion: { in: ->(_relationship) { relation_to_options }, message: "select option" }
  ...
  def self.relation_to_options
    %w[Parent Partner Child Family Friend]
  end
